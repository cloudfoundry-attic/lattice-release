...
Create a `lattice.tf` file (or use the provided [example](https://github.com/pivotal-cf-experimental/lattice/terraform/blob/master/google/lattice.tf.example)) and add the following contents updating the variables properly:
