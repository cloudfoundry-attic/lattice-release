...
type FakeBlobStore struct {
	ListStub        func() ([]s3_blob_store.Blob, error)
	listMutex       sync.RWMutex
	listArgsForCall []struct{}
	listReturns     struct {
		result1 []s3_blob_store.Blob
		result2 error
	}
...
func (fake *FakeBlobStore) List() ([]s3_blob_store.Blob, error) {
	fake.listMutex.Lock()
...
func (fake *FakeBlobStore) ListReturns(result1 []s3_blob_store.Blob, result2 error) {
	fake.ListStub = nil
