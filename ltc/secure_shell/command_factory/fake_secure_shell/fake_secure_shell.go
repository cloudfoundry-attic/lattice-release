...
func (fake *FakeSecureShell) ConnectAndForward(appName string, instanceIndex int, localAddress string, remoteAddress string, config *config_package.Config) error {
...
func (fake *FakeSecureShell) ConnectAndForwardCallCount() int {
	fake.connectAndForwardMutex.RLock()
	defer fake.connectAndForwardMutex.RUnlock()
	return len(fake.connectAndForwardArgsForCall)
}

func (fake *FakeSecureShell) ConnectAndForwardArgsForCall(i int) (string, int, string, string, *config_package.Config) {
	fake.connectAndForwardMutex.RLock()
	defer fake.connectAndForwardMutex.RUnlock()
...
func (fake *FakeSecureShell) ConnectAndForwardReturns(result1 error) {
